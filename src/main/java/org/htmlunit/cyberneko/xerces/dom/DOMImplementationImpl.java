...
public class DOMImplementationImpl implements DOMImplementation {
    ...
    public boolean hasFeature(String feature, final String version) {
        ...
        if ("XMLVersion".equalsIgnoreCase(feature)
                && (anyVersion || "1.0".equals(version) || "1.1".equals(version))) {
            return true;
        }
        if ("LS".equalsIgnoreCase(feature)
                && (anyVersion || "3.0".equals(version))) {
            return true;
        }
        if ("ElementTraversal".equalsIgnoreCase(feature)
                && (anyVersion || "1.0".equals(version))) {
            return true;
        }

        if ("Events".equalsIgnoreCase(feature)
                && (anyVersion || "2.0".equals(version))) {
            return true;
        }

        if ("MutationEvents".equalsIgnoreCase(feature)
                && (anyVersion || "2.0".equals(version))) {
            return true;
        }
