...
package net.sourceforge.htmlunit.xml.serialize;
...
import net.sourceforge.htmlunit.xerces.dom.DOMNormalizer;
 ...
 * @version $Id$
 * 
 * @deprecated Replaced by net.sourceforge.htmlunit.xml.serializer.dom3.LSSerializerImpl in Xerces 2.9.0.
 */
