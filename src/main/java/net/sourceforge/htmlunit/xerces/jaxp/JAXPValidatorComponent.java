...
package net.sourceforge.htmlunit.xerces.jaxp;
...
import net.sourceforge.htmlunit.xerces.dom.DOMInputImpl;
import net.sourceforge.htmlunit.xerces.impl.Constants;
import net.sourceforge.htmlunit.xerces.impl.XMLErrorReporter;
import net.sourceforge.htmlunit.xerces.impl.xs.opti.DefaultXMLDocumentHandler;
import net.sourceforge.htmlunit.xerces.util.AttributesProxy;
...
import net.sourceforge.htmlunit.xerces.util.LocatorProxy;
...
final class JAXPValidatorComponent 
     ...
     * to reuse its default {@link net.sourceforge.htmlunit.xerces.xni.XMLDocumentHandler}
     * implementation.
     * 
     * @author Kohsuke Kawaguchi (kohsuke.kawaguchi@sun.com)
     */
