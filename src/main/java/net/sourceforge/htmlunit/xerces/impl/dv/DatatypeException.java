...
public class DatatypeException extends Exception {
    ...
    public String getMessage() {
        ...
        if (resourceBundle == null)
            throw new MissingResourceException("Property file not found!", "net.sourceforge.htmlunit.xerces.impl.msg.XMLSchemaMessages", key);

        String msg = resourceBundle.getString(key);
        if (msg == null) {
            msg = resourceBundle.getString("BadMessageKey");
            throw new MissingResourceException(msg, "net.sourceforge.htmlunit.xerces.impl.msg.XMLSchemaMessages", key);
        }
