...
package net.sourceforge.htmlunit.xerces.impl.dv;
...
public abstract class DTDDVFactory {
    ...
    private static final String DEFAULT_FACTORY_CLASS = "net.sourceforge.htmlunit.xerces.impl.dv.dtd.DTDDVFactoryImpl";
     ...
     */
    public static DTDDVFactory getInstance() throws DVFactoryException {
     ...
     *                                class name or the default class name
     */
    public static DTDDVFactory getInstance(String factoryClass) throws DVFactoryException {
        try {
