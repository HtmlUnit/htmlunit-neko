...
class PrecisionDecimalDV extends TypeValidator {
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.htmlunit.xerces.impl.dv.xs.TypeValidator#getAllowedFacets()
     */
    @Override
    public short getAllowedFacets() {
        return ( XSSimpleTypeDefinition.FACET_PATTERN | XSSimpleTypeDefinition.FACET_WHITESPACE | XSSimpleTypeDefinition.FACET_ENUMERATION |XSSimpleTypeDefinition.FACET_MAXINCLUSIVE |XSSimpleTypeDefinition.FACET_MININCLUSIVE | XSSimpleTypeDefinition.FACET_MAXEXCLUSIVE  | XSSimpleTypeDefinition.FACET_MINEXCLUSIVE | XSSimpleTypeDefinition.FACET_TOTALDIGITS | XSSimpleTypeDefinition.FACET_FRACTIONDIGITS);
    }

    /* (non-Javadoc)
     * @see net.sourceforge.htmlunit.xerces.impl.dv.xs.TypeValidator#getActualValue(java.lang.String, net.sourceforge.htmlunit.xerces.impl.dv.ValidationContext)
     */
    @Override
