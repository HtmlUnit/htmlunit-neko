...
import net.sourceforge.htmlunit.xerces.impl.xs.XMLSchemaLoader;
import net.sourceforge.htmlunit.xerces.impl.xs.XSAttributeDecl;
import net.sourceforge.htmlunit.xerces.impl.xs.XSAttributeGroupDecl;
import net.sourceforge.htmlunit.xerces.impl.xs.XSComplexTypeDecl;
import net.sourceforge.htmlunit.xerces.impl.xs.XSDDescription;
...
import net.sourceforge.htmlunit.xerces.impl.xs.XSGrammarBucket;
import net.sourceforge.htmlunit.xerces.impl.xs.XSGroupDecl;
import net.sourceforge.htmlunit.xerces.impl.xs.XSMessageFormatter;
import net.sourceforge.htmlunit.xerces.impl.xs.XSModelGroupImpl;
import net.sourceforge.htmlunit.xerces.impl.xs.XSNotationDecl;
...
import net.sourceforge.htmlunit.xerces.impl.xs.opti.SchemaParsingConfig;
import net.sourceforge.htmlunit.xerces.impl.xs.util.SimpleLocator;
import net.sourceforge.htmlunit.xerces.impl.xs.util.XSInputSource;
import net.sourceforge.htmlunit.xerces.parsers.SAXParser;
import net.sourceforge.htmlunit.xerces.parsers.XML11Configuration;
import net.sourceforge.htmlunit.xerces.util.DOMInputSource;
...
import net.sourceforge.htmlunit.xerces.util.SAXInputSource;
import net.sourceforge.htmlunit.xerces.util.StAXInputSource;
...
import net.sourceforge.htmlunit.xerces.xni.grammars.XMLSchemaDescription;
...
import net.sourceforge.htmlunit.xerces.xs.XSAttributeDeclaration;
import net.sourceforge.htmlunit.xerces.xs.XSAttributeGroupDefinition;
import net.sourceforge.htmlunit.xerces.xs.XSAttributeUse;
import net.sourceforge.htmlunit.xerces.xs.XSConstants;
import net.sourceforge.htmlunit.xerces.xs.XSElementDeclaration;
import net.sourceforge.htmlunit.xerces.xs.XSModelGroup;
import net.sourceforge.htmlunit.xerces.xs.XSModelGroupDefinition;
...
import net.sourceforge.htmlunit.xerces.xs.XSParticle;
...
public class XSDHandler {
    ...
    private String doc2SystemId(Element ele) {
         ...
         */
        if(ele.getOwnerDocument() instanceof net.sourceforge.htmlunit.xerces.impl.xs.opti.SchemaDOM){
            documentURI = ((net.sourceforge.htmlunit.xerces.impl.xs.opti.SchemaDOM) ele.getOwnerDocument()).getDocumentURI();
        }
