...
public final class REUtil {
    ...
    /**
     * Sample entry.
     * <div>Usage: <KBD>net.sourceforge.htmlunit.xerces.utils.regex.REUtil &lt;regex&gt; &lt;string&gt;</KBD></div>
     */
    public static void main(String[] argv) {
        ...
        try {
            ...
            if (pattern == null) {
                ...
                System.err.println("net.sourceforge.htmlunit.xerces.utils.regex.ParseException: "+pe.getMessage());
                String indent = "        ";
