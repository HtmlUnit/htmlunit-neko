...
public class XMLEntityScanner implements XMLLocator {
     ...
     *
     * @see net.sourceforge.htmlunit.xerces.util.EncodingMap
     */
     ...
     * @see net.sourceforge.htmlunit.xerces.util.SymbolTable
     * @see net.sourceforge.htmlunit.xerces.util.XMLChar#isName
     * @see net.sourceforge.htmlunit.xerces.util.XMLChar#isNameStart
     */
     ...
     * @see net.sourceforge.htmlunit.xerces.util.XMLChar#isNCNameStart
     */
     ...
     * @throws EOFException Thrown on end of file.
     *
     * @see net.sourceforge.htmlunit.xerces.util.XMLChar#isSpace
     */
