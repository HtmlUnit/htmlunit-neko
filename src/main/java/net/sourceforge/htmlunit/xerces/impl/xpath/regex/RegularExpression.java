...
package net.sourceforge.htmlunit.xerces.impl.xpath.regex;
 ...
 * after <code><a href="#matches(java.lang.String, net.sourceforge.htmlunit.xerces.utils.regex.Match)">matches(String,Match)</a></code>.
...
//Public
     ...
     * @exception net.sourceforge.htmlunit.xerces.utils.regex.ParseException <VAR>regex</VAR> is not conforming to the syntax.
     */
