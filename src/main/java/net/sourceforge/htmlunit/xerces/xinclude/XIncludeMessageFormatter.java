...
public class XIncludeMessageFormatter implements MessageFormatter {
    ...
    public String formatMessage(Locale locale, String key, Object[] arguments)
        ...
        if (locale != fLocale) {
            fResourceBundle = ResourceBundle.getBundle("net.sourceforge.htmlunit.xerces.impl.msg.XIncludeMessages", locale);
        ...
        if (msg == null) {
            ...
            throw new MissingResourceException(msg, "net.sourceforge.htmlunit.xerces.impl.msg.XIncludeMessages", key);
        }
