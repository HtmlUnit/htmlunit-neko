...
package net.sourceforge.htmlunit.xerces.xinclude;
...
import net.sourceforge.htmlunit.xerces.xni.parser.XMLDTDFilter;
...
import net.sourceforge.htmlunit.xerces.xpointer.XPointerHandler;
import net.sourceforge.htmlunit.xerces.xpointer.XPointerProcessor;
...
public class XIncludeHandler
    ...
    public final static String XINCLUDE_DEFAULT_CONFIGURATION =
        "net.sourceforge.htmlunit.xerces.parsers.XIncludeParserConfiguration";
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.htmlunit.xerces.xni.XMLDTDHandler#attributeDecl(java.lang.String, java.lang.String, java.lang.String, java.lang.String[], java.lang.String, net.sourceforge.htmlunit.xerces.xni.XMLString, net.sourceforge.htmlunit.xerces.xni.XMLString, net.sourceforge.htmlunit.xerces.xni.Augmentations)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.htmlunit.xerces.xni.XMLDTDHandler#elementDecl(java.lang.String, java.lang.String, net.sourceforge.htmlunit.xerces.xni.Augmentations)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.htmlunit.xerces.xni.XMLDTDHandler#endAttlist(net.sourceforge.htmlunit.xerces.xni.Augmentations)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.htmlunit.xerces.xni.XMLDTDHandler#endConditional(net.sourceforge.htmlunit.xerces.xni.Augmentations)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.htmlunit.xerces.xni.XMLDTDHandler#endDTD(net.sourceforge.htmlunit.xerces.xni.Augmentations)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.htmlunit.xerces.xni.XMLDTDHandler#endExternalSubset(net.sourceforge.htmlunit.xerces.xni.Augmentations)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.htmlunit.xerces.xni.XMLDTDHandler#endParameterEntity(java.lang.String, net.sourceforge.htmlunit.xerces.xni.Augmentations)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.htmlunit.xerces.xni.XMLDTDHandler#externalEntityDecl(java.lang.String, net.sourceforge.htmlunit.xerces.xni.XMLResourceIdentifier, net.sourceforge.htmlunit.xerces.xni.Augmentations)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.htmlunit.xerces.xni.XMLDTDHandler#getDTDSource()
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.htmlunit.xerces.xni.XMLDTDHandler#ignoredCharacters(net.sourceforge.htmlunit.xerces.xni.XMLString, net.sourceforge.htmlunit.xerces.xni.Augmentations)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.htmlunit.xerces.xni.XMLDTDHandler#internalEntityDecl(java.lang.String, net.sourceforge.htmlunit.xerces.xni.XMLString, net.sourceforge.htmlunit.xerces.xni.XMLString, net.sourceforge.htmlunit.xerces.xni.Augmentations)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.htmlunit.xerces.xni.XMLDTDHandler#notationDecl(java.lang.String, net.sourceforge.htmlunit.xerces.xni.XMLResourceIdentifier, net.sourceforge.htmlunit.xerces.xni.Augmentations)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.htmlunit.xerces.xni.XMLDTDHandler#setDTDSource(net.sourceforge.htmlunit.xerces.xni.parser.XMLDTDSource)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.htmlunit.xerces.xni.XMLDTDHandler#startAttlist(java.lang.String, net.sourceforge.htmlunit.xerces.xni.Augmentations)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.htmlunit.xerces.xni.XMLDTDHandler#startConditional(short, net.sourceforge.htmlunit.xerces.xni.Augmentations)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.htmlunit.xerces.xni.XMLDTDHandler#startDTD(net.sourceforge.htmlunit.xerces.xni.XMLLocator, net.sourceforge.htmlunit.xerces.xni.Augmentations)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.htmlunit.xerces.xni.XMLDTDHandler#startExternalSubset(net.sourceforge.htmlunit.xerces.xni.XMLResourceIdentifier, net.sourceforge.htmlunit.xerces.xni.Augmentations)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.htmlunit.xerces.xni.XMLDTDHandler#startParameterEntity(java.lang.String, net.sourceforge.htmlunit.xerces.xni.XMLResourceIdentifier, java.lang.String, net.sourceforge.htmlunit.xerces.xni.Augmentations)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.htmlunit.xerces.xni.XMLDTDHandler#unparsedEntityDecl(java.lang.String, net.sourceforge.htmlunit.xerces.xni.XMLResourceIdentifier, java.lang.String, net.sourceforge.htmlunit.xerces.xni.Augmentations)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.htmlunit.xerces.xni.parser.XMLDTDSource#getDTDHandler()
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.htmlunit.xerces.xni.parser.XMLDTDSource#setDTDHandler(net.sourceforge.htmlunit.xerces.xni.XMLDTDHandler)
     */
    ...
    protected boolean handleIncludeElement(XMLAttributes attributes)
        ...
        if (parse.equals(XINCLUDE_PARSE_XML)) {
            ...
            if ((xpointer != null && fXPointerChildConfig == null) 
            	...
            	if (xpointer != null)
            		parserName = "net.sourceforge.htmlunit.xerces.parsers.XPointerParserConfiguration";
