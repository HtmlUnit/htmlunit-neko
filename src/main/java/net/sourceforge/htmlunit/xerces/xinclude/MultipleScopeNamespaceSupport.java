...
public class MultipleScopeNamespaceSupport extends NamespaceSupport {
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.htmlunit.xerces.xni.NamespaceContext#getPrefix(java.lang.String)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.htmlunit.xerces.xni.NamespaceContext#getURI(java.lang.String)
     */
