...
final class ShortHandPointer implements XPointerPart {
     ...
     * 
     * @see net.sourceforge.htmlunit.xerces.xpointer.XPointerPart#parseXPointer(java.lang.String)
     */
     ...
     *
     * @see net.sourceforge.htmlunit.xerces.xpointer.XPointerPart#resolveXPointer(net.sourceforge.htmlunit.xerces.xni.QName, net.sourceforge.htmlunit.xerces.xni.XMLAttributes, net.sourceforge.htmlunit.xerces.xni.Augmentations, int event)
     */
    ...
    /**
     * 
     * @see net.sourceforge.htmlunit.xerces.xpointer.XPointerPart#isFragmentResolved()
     */
