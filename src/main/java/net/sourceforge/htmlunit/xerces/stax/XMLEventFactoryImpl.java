...
package net.sourceforge.htmlunit.xerces.stax;
...
import net.sourceforge.htmlunit.xerces.stax.events.AttributeImpl;
import net.sourceforge.htmlunit.xerces.stax.events.CharactersImpl;
import net.sourceforge.htmlunit.xerces.stax.events.CommentImpl;
import net.sourceforge.htmlunit.xerces.stax.events.DTDImpl;
import net.sourceforge.htmlunit.xerces.stax.events.EndDocumentImpl;
import net.sourceforge.htmlunit.xerces.stax.events.EndElementImpl;
import net.sourceforge.htmlunit.xerces.stax.events.EntityReferenceImpl;
import net.sourceforge.htmlunit.xerces.stax.events.NamespaceImpl;
import net.sourceforge.htmlunit.xerces.stax.events.ProcessingInstructionImpl;
import net.sourceforge.htmlunit.xerces.stax.events.StartDocumentImpl;
import net.sourceforge.htmlunit.xerces.stax.events.StartElementImpl;
