...
package net.sourceforge.htmlunit.xerces.stax.events;
...
import net.sourceforge.htmlunit.xerces.stax.EmptyLocation;
import net.sourceforge.htmlunit.xerces.stax.ImmutableLocation;
