    ...
    protected void checkFeature(String featureId)
        ...
        if (featureId.startsWith(Constants.XERCES_FEATURE_PREFIX)) {
            ...
            if ((suffixLength == Constants.SCHEMA_VALIDATION_FEATURE.length() &&
                featureId.endsWith(Constants.SCHEMA_VALIDATION_FEATURE)) || (suffixLength == Constants.SCHEMA_FULL_CHECKING.length() &&
    ...
    protected void checkProperty(String propertyId)
        ...
        if (propertyId.startsWith(Constants.XERCES_PROPERTY_PREFIX)) {
            ...
            if ((suffixLength == Constants.SCHEMA_LOCATION.length() &&
                propertyId.endsWith(Constants.SCHEMA_LOCATION)) || (suffixLength == Constants.SCHEMA_NONS_LOCATION.length() &&
