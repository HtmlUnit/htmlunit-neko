...
import net.sourceforge.htmlunit.xerces.impl.dtd.DTDGrammar;
...
public abstract class DTDParser
     ...
     * @throws XNIException Thrown by handler to signal an error.
     *
     * @see net.sourceforge.htmlunit.xerces.impl.dtd.XMLElementDecl#TYPE_EMPTY
     * @see net.sourceforge.htmlunit.xerces.impl.dtd.XMLElementDecl#TYPE_ANY
     * @see net.sourceforge.htmlunit.xerces.impl.dtd.XMLElementDecl#TYPE_MIXED
     * @see net.sourceforge.htmlunit.xerces.impl.dtd.XMLElementDecl#TYPE_CHILDREN
     */
